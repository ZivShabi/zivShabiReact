...
import { signUpValidationSchema } from '../hooks/useSignUpValidation'
...
function SignUp() {
    ...
    function validateField(name, value) {
        const schemaForField = Joi.object({ [name]: signUpValidationSchema.extract(name) })
    ...
    async function handleSubmit(event) {
        ...
        const { error } = signUpValidationSchema.validate(form, { abortEarly: false })
        if (error) {
